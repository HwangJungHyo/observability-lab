...
실험 번호 001~014과 챕터 번호는 별개다. 실험 문서는 각 챕터의 증거로 연결한다.
...
| 6 트레이스 | 어느 처리 구간이 느린가? OpenTelemetry·Tempo | 주문·결제 구간 지연 식별 | 2~3 | 6-1~6-3·6-4a 완료, 6-4b 중단 트레이스 검증 예정 |
...
- [ ] 6-4b 결제 중단 시 오류 span·로그 비교·복구·기록
